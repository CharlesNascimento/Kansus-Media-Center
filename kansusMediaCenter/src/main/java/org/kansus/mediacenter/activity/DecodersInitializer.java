...
public class DecodersInitializer extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new AsyncTask<Object, Object, Boolean>() {
			...
			protected void onPreExecute() {
				mPD = new ProgressDialog(DecodersInitializer.this);
			...
			protected Boolean doInBackground(Object... params) {
				return Vitamio.isInitialized(DecodersInitializer.this);
			}
	...
	private static class UIHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			DecodersInitializer ctx = (DecodersInitializer) mContext.get();
			switch (msg.what) {
			case 0:
				ctx.mPD.dismiss();
