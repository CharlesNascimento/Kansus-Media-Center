...
/**
 * Classe responsável por gerenciar o player de vídeo.
 */
public class MovieViewControl implements MediaPlayer.OnErrorListener,
    ...
    private final io.vov.vitamio.widget.VideoView mVideoView;
    ...
    public io.vov.vitamio.widget.MediaController mMediaController;
    ...
    public MovieViewControl(View rootView, Context context, Uri videoUri) {
        ...
        mVideoView.setOnPreparedListener(new OnPreparedListener() {
			...
			public void onPrepared(MediaPlayer paramMediaPlayer) {
				mVideoView.addTimedTextSource(Environment.getExternalStorageDirectory().getAbsolutePath() + "/DESABAFO DE UM JAPA.srt");
				mVideoView.setTimedTextEncoding("UTF-8");
				mVideoView.setSubTrack(5);
				mVideoView.setTimedTextShown(true);
				System.out.println(mVideoView.getTimedTextPath());
			}
		});
        ...
        if (bookmark != null) {
        	...
        	mVideoView.addTimedTextSource(Environment.getExternalStorageDirectory().getAbsolutePath() + "/DESABAFO DE UM JAPA.srt");
            mVideoView.setTimedTextShown(true);
        	System.out.println("EXISTE???? " + new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/DESABAFO DE UM JAPA.srt").exists());
            mVideoView.start();
        }
    }
    ...
    public void onPause() {
        ...
        setBookmark((int) mVideoView.getCurrentPosition());
