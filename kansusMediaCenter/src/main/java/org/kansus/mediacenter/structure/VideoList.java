...
/**
 * Representa uma coleção de todos os <code>VideoObject</code> na aplicação.
 */
public class VideoList extends BaseImageList {
	...
	/** Construtor
	 * @param resolver Content Rosolver.
	 * @param uri Endereço da lista.
	 * @param sort Sentido da ordenação.
	 * @param bucketId Bucket ID da lista.
	 */
