...
/**
 * Representa as imagens normais da aplicação.
 */
public class Image extends BaseImage implements IImage {
	...
	/**
	 * Define o grau de rotação da imagem.
	 * 
	 * @param degrees
	 *            Grau de rotação da imagem.
	 */
	...
	/**
	 * Substitui uma tag Exit exitente. Se ela não existir, a tag é simplesmente
	 * adicionada.
	 * 
	 * @param tag Campo a ser alterado.
	...
	/**
	 * Carrega os atributos Exif da imagem.
	 */
	...
	/**
	 * Salva os atributos Exif na imagem.
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Define a tag Exif "Orientation" da imagem para os graus desejados.
	 * 
	 * @param degrees
	 *            Graus que a imagem está rotacionada.
	 */
	...
	/**
	 * Salva a imagem rotacionada atualizando a tag "Orientation" do Exif.
	 * 
	 * @param degrees
	 *            Graus a serem rotacionados.
	 */
