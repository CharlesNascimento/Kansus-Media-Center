...
/**
 * Representa o algoritmo de cache LRU (Least Recently Used).
 * 
 * @param <K>
 *            Chave.
 * @param <V>
...
public class LruCache<K, V> {
	 ...
	 * 
	 * @param capacity
	 *            Capacidade de memória da cache.
	 */
	...
	/**
	 * Recupera um valor na cache.
	 * 
	 * @param key
	 *            Chave do valor a ser recuperado.
