...
/**
 * Representa uma coleção ordenada de objetos {@link Image}.
 */
public class ImageList extends BaseImageList implements IImageList {
	...
	private static final String[] ACCEPTABLE_IMAGE_TYPES = new String[] {
			"image/jpeg", "image/png", "image/gif", "image/bmp", "image/tiff", "image/webm" };
	...
	/**
	 * Pega a cláusula Where para a consulta no SQLite.
	 * 
	 * @return Uma <code>String</code> contendo a cláusula Where.
	 */
	...
	/**
	 * Pega os argumentos da cláusula Where para a consulta no SQLite.
	 * 
	 * @return Um <code>String[]</code> contendo os argumentos da cláusula
	 *         Where.
	 */
