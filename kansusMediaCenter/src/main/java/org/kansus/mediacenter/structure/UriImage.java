...
/**
 * Representa uma imagem que só tem um {@link Uri} como parâmetro.
 */
class UriImage implements IImage {
	...
	/**
	 * Pega o {@link InputStream} da imagem.
	 * 
	 * @return O {@link InputStream} da imagem.
	 */
	...
	/**
	 * Pega um {@link ParcelFileDescriptor} associado à imagem.
	 * 
	 * @return Um {@link ParcelFileDescriptor} associado à imagem.
	 */
	 ...
	 * 
	 * @return Um {@link BitmapFactory.Options} contendo as informações da
	 *         imagem.
	 */
