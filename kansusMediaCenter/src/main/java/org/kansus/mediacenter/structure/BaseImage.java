...
/**
 * Representa uma imagem particular e provém acesso ao seu Bitmap, assim como
 * aos Bitmaps de duas miniaturas e à informações tais como id e caminho da
 * imagem em si.
 */
public abstract class BaseImage implements IImage {
	...
	/**
	 * Construtor.
	 * @param container Lista à qual a imagem pertence.
	 * @param cr Content Resolver.
	 * @param id ID da imagem.
	 * @param index Índice da imagem na lista.
	 * @param uri Endereço da imagem.
	 * @param dataPath Caminho dos dados da imagem.
	 * @param mimeType Mime Type da imagem.
	 * @param dateTaken Data em que a imagem foi criada (tirada).
	...
	/**
	 * Método chamado quando a imagem é removida de uma lista.
	 */
