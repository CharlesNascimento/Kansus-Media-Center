...
/**
 * Uma união de diferentes <code>IImageList</code>. Esta classe pode mesclar
 * várias <code>IImageList</code> em uma única lista e ordená-las de acordo com
 * o timestamp.
 */
public class ImageListUber implements IImageList {
	 ...
	 * 
	 * @param sublist
	 *            conjunto de sublistas que vão ser mescladas.
	 * @param sort
	...
	/**
	 * Pega o próximo {@link MergeSlot} da fila.
	 * 
	 * @return próximo {@link MergeSlot} da fila.
	 */
	...
	/**
	 * Modifica a skipList quando um imagem é deletada, encontrando a entrada
	 * relevante na mSkipList e decrementando o contador.
	 * 
	 * @param index
	 *            índice da imagem deletada.
	 */
	...
	/**
	 * Classe que implementa um comparador para datas, em ordem decrescente.
	 */
	...
	/**
	 * Classe que implementa um comparador para datas, em ordem crescente.
	 */
	...
	/**
	 * Um <code>MergeSlot</code> é usado para traçar a posição atual de uma sublista. Para
	 * cada sublista dada, haverá um <code>MergeSlot</code> correspondente.
	 */
	private static class MergeSlot {
		/*
		 * We use merge-sort-like algorithm to build the merged list. At
		 * begining, we put all the slots in a sorted heap (by timestamp). Each
		 * time, we pop the slot with earliest timestamp out, get the image, and
		 * then move the index forward, and put it back to the heap. Um
		 * MergeSlot
		 */
		...
		/**
		 * Construtor.
		 * @param list lista para este slot.
		 * @param index posição atual da lista.
		 */
		...
		/**
		 * Aponta para a próxima imagem da sublista.
		 * @return <code>true</code> se a operação sucedeu.
		 */
		public boolean next() {
